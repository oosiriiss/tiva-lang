...
// clang-format off
void IntegerAstNode::accept(AstNodeVisitor *visitor) { visitor->visit(this); }
void FloatAstNode::accept(AstNodeVisitor *visitor) { visitor->visit(this); }
void VariableAstNode::accept(AstNodeVisitor *visitor) { visitor->visit(this); }
void AssignmentAstNode::accept(AstNodeVisitor *visitor) { visitor->visit(this); }
void CallAstNode::accept(AstNodeVisitor *visitor) { visitor->visit(this); }
void BinaryExprAstNode::accept(AstNodeVisitor *visitor) { visitor->visit(this); }
